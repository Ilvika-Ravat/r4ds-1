...
ggplot() +
  ...
  scale_color_viridis_c(option = "plasma", name = "Hotttness") +
  coord_fixed(1.3) +
  labs(
    title = "Artist Locations with Positive Hotttness",
    subtitle = "Point color encodes artist hotttness; only artists with usable coordinates and hotttness > 0 are shown.",
    x = "Longitude",
    y = "Latitude",
